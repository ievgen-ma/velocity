	...
	return (function(global, window, document, undefined) {
						...
						opts.complete = function() {
							...
							if (properties.reset) {
								for (var resetProperty in properties.reset) {
									if (
										!properties.reset.hasOwnProperty(
											resetProperty
										)
									) {
										continue;
		...
		Velocity.RegisterEffect.packagedEffects = {
			...
			"callout.pulse": {
				defaultDuration: 825,
				calls: [
					[{ scale: 1.1 }, 0.5, { easing: "easeInExpo" }],
					[{ scale: 1 }, 0.5]
				]
			},
			/* Animate.css */
			...
			"callout.tada": {
				defaultDuration: 1000,
				calls: [
					[{ scale: 0.9, rotateZ: -3 }, 0.1],
					[{ scale: 1.1, rotateZ: 3 }, 0.1],
					[{ scale: 1.1, rotateZ: -3 }, 0.1],
					["reverse", 0.125],
					["reverse", 0.125],
					["reverse", 0.125],
			...
			"transition.fadeIn": {
				defaultDuration: 500,
				calls: [[{ opacity: 0 }, 0], [{ opacity: 1 }, 1]]
			},
			"transition.fadeOut": {
				defaultDuration: 500,
				calls: [[{ opacity: 1 }, 0], [{ opacity: 0 }, 1]]
			},
			...
			"transition.flipXIn": {
				...
				calls: [
					[
						{ opacity: 0, transformPerspective: 800, rotateY: -55 },
						0
					],
			...
			"transition.flipYIn": {
				...
				calls: [
					[
						{ opacity: 0, transformPerspective: 800, rotateX: -45 },
						0
					],
			...
			"transition.whirlOut": {
				...
				calls: [
					...
					[
						{ opacity: 0, scaleX: 0, scaleY: 0, rotateY: 160 },
						1,
			...
			"transition.bounceLeftIn": {
				...
				calls: [
					[
						{ opacity: 0, translateX: -1250 },
						0.3,
						{ easing: "easeOutCirc" }
					],
					[{ opacity: 1, translateX: 30 }, 0.3],
					[{ translateX: -10 }, 0.2],
					[{ translateX: 0 }, 0.2]
				]
			},
		...
		for (var effectName in Velocity.RegisterEffect.packagedEffects) {
			if (
				Velocity.RegisterEffect.packagedEffects.hasOwnProperty(
					effectName
				)
			) {
